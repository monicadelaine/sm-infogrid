...
/**
  * <p>Java implementation class for EntityType com.example.model.House/RelativeAction.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>com.example.model.House/RelativeAction</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>RelativeChannelAction</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>RelativeChannelAction</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>Relative action; result based on current state</td></tr></table></td></tr>
  * </table>
  */

public class ImplRelativeChannelAction
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.example.model.House.RelativeChannelAction

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplRelativeChannelAction.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplRelativeChannelAction(
            MeshObject delegate )
    {
        super( delegate );
    }
