...
package org.infogrid.model.Annotation.module;
...
/**
  * Instantiates Module org.infogrid.model.Annotation (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.model.Annotation",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Annotation Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1458519436349L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.Annotation.jar" )
                        },
                        null,
                        null );
