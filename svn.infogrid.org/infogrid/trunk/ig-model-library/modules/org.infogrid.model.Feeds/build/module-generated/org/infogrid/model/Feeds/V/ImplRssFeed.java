...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Feeds/RssFeed.</p>
...
public class ImplRssFeed
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Feeds.RssFeed

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplRssFeed.class ); // our own, private logger
    ...
    /**
      * Set value for property Description.
      *
      * @param newValue the new value for the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      * @throws org.infogrid.meshbase.transaction.TransactionException thrown if invoked outside proper transaction boundaries
    ...
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setDescription", newValue );
        }

        try {
            the_Delegate.setPropertyValue( DESCRIPTION, newValue );
    ...
    /**
      * Obtain value for property Description.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.BlobValue getDescription()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.BlobValue) the_Delegate.getPropertyValue( DESCRIPTION );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
