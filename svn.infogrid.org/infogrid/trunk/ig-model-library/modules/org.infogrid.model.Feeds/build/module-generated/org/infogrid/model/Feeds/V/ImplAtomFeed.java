...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Feeds/AtomFeed.</p>
...
public class ImplAtomFeed
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Feeds.AtomFeed

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplAtomFeed.class ); // our own, private logger
    ...
    /**
      * Set value for property Subtitle.
      *
            ...
            org.infogrid.mesh.IllegalPropertyValueException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setSubtitle", newValue );
        }

        try {
            the_Delegate.setPropertyValue( SUBTITLE, newValue );
    ...
    /**
      * Obtain value for property Subtitle.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.BlobValue getSubtitle()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.BlobValue) the_Delegate.getPropertyValue( SUBTITLE );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
