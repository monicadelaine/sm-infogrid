...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Feeds/AtomFeedItem.</p>
...
public class ImplAtomFeedItem
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Feeds.AtomFeedItem

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplAtomFeedItem.class ); // our own, private logger
    ...
    /**
      * Set value for property Summary.
      *
            ...
            org.infogrid.mesh.IllegalPropertyValueException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setSummary", newValue );
        }

        try {
            the_Delegate.setPropertyValue( SUMMARY, newValue );
    ...
    /**
      * Obtain value for property Summary.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.BlobValue getSummary()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.BlobValue) the_Delegate.getPropertyValue( SUMMARY );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
