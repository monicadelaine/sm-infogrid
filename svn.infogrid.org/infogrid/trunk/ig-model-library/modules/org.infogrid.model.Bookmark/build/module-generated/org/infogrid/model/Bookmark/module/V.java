...
package org.infogrid.model.Bookmark.module;
...
/**
  * Instantiates Module org.infogrid.model.Bookmark (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.model.Bookmark",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Bookmarking Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080602421L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.Bookmark.jar" )
                        },
                        null,
                        null );
