...
package org.infogrid.model.Requirement.module;
...
/**
  * Instantiates Module org.infogrid.model.Requirement (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.model.Requirement",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Requirements Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080609645L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.Requirement.jar" )
                        },
                        null,
                        null );
