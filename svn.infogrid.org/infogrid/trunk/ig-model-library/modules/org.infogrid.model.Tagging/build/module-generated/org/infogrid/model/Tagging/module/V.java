...
package org.infogrid.model.Tagging.module;
...
/**
  * Instantiates Module org.infogrid.model.Tagging (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tagging Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080612703L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.Tagging.jar" )
                        },
                        null,
                        null );
