...
package org.infogrid.model.Blob.module;
...
/**
  * Instantiates Module org.infogrid.model.Blob (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Blob (Binary Large Objects) Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080599288L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.Blob.jar" )
                        },
                        null,
                        null );
