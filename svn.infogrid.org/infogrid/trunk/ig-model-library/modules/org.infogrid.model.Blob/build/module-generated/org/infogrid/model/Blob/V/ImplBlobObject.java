...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Blob/BlobObject.</p>
...
public class ImplBlobObject
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Blob.BlobObject

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplBlobObject.class ); // our own, private logger
    ...
    /**
      * Set value for property CodeBase.
      *
      * @param newValue the new value for the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      * @throws org.infogrid.meshbase.transaction.TransactionException thrown if invoked outside proper transaction boundaries
    ...
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setCodeBase", newValue );
        }

        try {
            the_Delegate.setPropertyValue( CODEBASE, newValue );
    ...
    /**
      * Obtain value for property CodeBase.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.StringValue getCodeBase()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.StringValue) the_Delegate.getPropertyValue( CODEBASE );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
