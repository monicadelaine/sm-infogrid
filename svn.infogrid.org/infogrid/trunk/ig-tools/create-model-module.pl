#!/usr/bin/perl
#
# Create an InfoGrid model project
#
...
my @allDependencies = (
    "../$igPath/ig-graphdb/modules/org.infogrid.codegen",
...
<!--
    InfoGrid model.xml template generated by $0
-->
<!DOCTYPE model PUBLIC '-//InfoGrid.org//InfoGrid Model//EN' 'http://infogrid.org/dtds/model.dtd'>
<model>
    <subjectarea ID="$projectName">
        <name>$projectName</name>
<!-- CHANGE THIS?
        <username>$projectName Subject Area</username>
        <userdescription>$projectName Subject Area</userdescription>
-->
END
...
$model .= <<END;
<!-- INSERT YOUR MODEL HERE, e.g.:

        <entitytype ID="$projectName/Foo">
            <name>Foo</name>
            <username>My Foo type</username>
            <userdescription>All Foos are blessed with this</userdescription>
            <propertytype ID="$projectName/Foo_Bar">
                <name>Bar</name>
                <username>My Bar property of Foo</username>
                <userdescription>Captures the Bar property of Foo objects</userdescription>
                <datatype>
                    <StringDataType/>
                </datatype>
                <isoptional/>
        ...
        <relationshiptype ID="$projectName/Argl_Likes_Brgl">
            <name>Argl_Likes_Brgl</name>
            <username>Likes</username>
            <userdescription>Relates those Argls to those Brgls that like each other.</userdescription>
            <src>
              <e>$projectName/Argl</e>
              <MultiplicityValue>0:N</MultiplicityValue>
            </src>
            <dest>
              <e>$projectName/Brgl</e>
              <MultiplicityValue>0:N</MultiplicityValue>
            </dest>
        </relationshiptype>
-->
...
END
writeFile( "$projectName/infogrid-models/model.xml", $model );
...
is divided into following sections:
  ...
  - cleanup
        ...
        -->
<project xmlns:j2seproject1="http://www.netbeans.org/ns/j2se-project/1" xmlns:j2seproject3="http://www.netbeans.org/ns/j2se-project/3" xmlns:jaxrpc="http://www.netbeans.org/ns/j2se-project/jax-rpc" basedir=".." default="default" name="org.infogrid.model.Tagging-impl">
    ...
    <target if="already.built.jar.\${basedir}" name="-warn-already-built-jar">
        <echo level="warn" message="Cycle detected: org.infogrid.model.Tagging was already built"/>
    </target>
...
$buildXml .= <<END;
    ...
    <target if="do.depend.true" name="-compile-depend">
        ...
        <j2seproject3:depend srcdir="\${src.dir}:\${src.module-generated.dir}:\${build.generated.subdirs}"/>
    </target>
    ...
    <target depends="init,deps-jar,-pre-pre-compile" name="-do-compile-single">
        ...
        <j2seproject3:javac excludes="" gensrcdir="\${build.generated.sources.dir}" includes="\${javac.includes}" sourcepath="\${src.dir}:\${src.module-generated.dir}"/>
    </target>
...
writeFile( "$projectName/nbproject/private/private.xml", "# placeholder\n" );
