...
package org.infogrid.kernel.net.test.xpriso.module;
...
/**
  * Instantiates Module org.infogrid.kernel.net.test.xpriso (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.kernel.net.test.xpriso",
                        null,
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests the Xpriso protocol implementation in InfoGrid."
                                }
                        }),
                        new java.util.Date( 1456080689570L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/kernel/net/test/xpriso/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.kernel.net.test.xpriso.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.kernel.net.test.xpriso.AllTests",
                        "main" );
