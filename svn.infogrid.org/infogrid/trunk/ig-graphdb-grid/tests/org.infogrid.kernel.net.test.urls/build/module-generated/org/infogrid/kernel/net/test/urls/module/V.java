...
package org.infogrid.kernel.net.test.urls.module;
...
/**
  * Instantiates Module org.infogrid.kernel.net.test.urls (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.kernel.net.test.urls",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "NetMeshObjectIdentifiers test Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests the convertion of NetMeshObjectIdentifier from and to URLs."
                                }
                        }),
                        new java.util.Date( 1456080687067L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/kernel/net/test/urls/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        "org.infogrid.util.logging.LogFactory.Class",
                                                        "org.infogrid.util.logging.log4j.Log4jLogFactory"
                                                },
                                                {
                                                        "org.infogrid.util.logging.LogFactory.Module",
                                                        "org.infogrid.util.logging.log4j"
                                                }
                                        }),
                                        null ),
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.kernel.net.test.urls.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.kernel.net.test.urls.AllTests",
                        "main" );
