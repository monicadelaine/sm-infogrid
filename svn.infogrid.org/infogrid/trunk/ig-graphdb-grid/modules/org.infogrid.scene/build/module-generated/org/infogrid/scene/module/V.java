...
package org.infogrid.scene.module;
...
/**
  * Instantiates Module org.infogrid.scene (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid Scenes Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Defines the concept of an InfoGrid Scene."
                                }
                        }),
                        new java.util.Date( 1456080681797L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.scene.jar" )
                        },
                        null,
                        null,
