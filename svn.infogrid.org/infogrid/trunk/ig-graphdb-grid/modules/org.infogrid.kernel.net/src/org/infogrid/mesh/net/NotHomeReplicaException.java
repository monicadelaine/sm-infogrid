...
/**
 * This Exception indicates that an attempt was made to move the home replica
 * from a local NetMeshObject to one at a different NetMeshBase; however, the
 * local replica did not have home replica status itself.
 */
            ...
            CanBeDumped
{
     ...
     * @param meshObject the NetMeshObject that did not have home replica status, if available
     * @param meshObjectIdentifier the NetMeshObjectIdentifier for the NetMeshObject that did not have home replica status
     */
    public NotHomeReplicaException(
            NetMeshBase             mb,
     ...
     *
     * @param meshObject the NetMeshObject that did not have home replica status
     */
    public NotHomeReplicaException(
            NetMeshObject meshObject )
    {
    ...
    /**
     * Obtain the NetMeshObject that did not have home replica status.
     * 
    ...
    /**
      * Obtain the NetMeshObjectIdentifier of the NetMeshObject that did not have home replica status.
      *
    ...
    /**
     * The NetMeshObject that did not have home replica status.
     */
    protected transient NetMeshObject theMeshObject;

    /**
     * The NetMeshObjectIdentifier of the NetMeshObject that did not have home replica status.
     */
