...
public class BulkExternalizedNetMeshObjectXmlEncoder
        ...
        implements
            BulkLoader,
            BulkExternalizedNetMeshObjectXmlTags
{
    private static final Log log = Log.getLogInstance( BulkExternalizedNetMeshObjectXmlEncoder.class ); // our own, private logger

    /**
     * Constructor.
     */
    public BulkExternalizedNetMeshObjectXmlEncoder()
    {
        // noop
    }
