...
package org.infogrid.vendors.com.mysql.jdbc.module;
...
/**
  * Instantiates Module org.infogrid.vendors.com.mysql.jdbc (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        new java.util.Date( 1456080507911L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.vendors.com.mysql.jdbc.jar" ),
                                new File( "dist/mysql-connector-java-bin.jar" )
                        },
                        null,
                        null,
