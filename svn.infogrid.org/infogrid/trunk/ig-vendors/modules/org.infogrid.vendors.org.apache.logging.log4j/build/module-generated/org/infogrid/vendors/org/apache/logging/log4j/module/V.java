...
package org.infogrid.vendors.org.apache.logging.log4j.module;
...
/**
  * Instantiates Module org.infogrid.vendors.org.apache.logging.log4j (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.vendors.org.apache.logging.log4j",
                        null,
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Wraps Log4j in an InfoGrid Module."
                                }
                        }),
                        new java.util.Date( 1456080515463L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.vendors.org.apache.logging.log4j.jar" ),
