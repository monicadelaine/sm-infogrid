 ...
 */
public class SqlStoreIteratorTest1
        extends
            AbstractStoreIteratorTest1
{
    ...
    public static void main(
            String [] args )
    {
        SqlStoreIteratorTest1 test = null;
        try {
            if( args.length != 1 ) {
            ...
            test = new SqlStoreIteratorTest1( args );
            test.run();
     ...
     */
    public SqlStoreIteratorTest1(
            String [] args )
        throws
            Exception
    {
        super( localFileName( SqlStoreIteratorTest1.class, "/ResourceHelper" ));
    ...
    // Our Logger
    private static Log log = Log.getLogInstance( SqlStoreIteratorTest1.class );
}
