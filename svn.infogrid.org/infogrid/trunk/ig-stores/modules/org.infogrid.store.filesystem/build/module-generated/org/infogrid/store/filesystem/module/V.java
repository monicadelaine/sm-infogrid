...
package org.infogrid.store.filesystem.module;
...
/**
  * Instantiates Module org.infogrid.store.filesystem (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Filesystem-based Store Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Implements the Store abstraction using the local file system."
                                }
                        }),
                        new java.util.Date( 1456080521297L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.store.filesystem.jar" )
                        },
                        null,
                        null,
