...
package org.infogrid.store.module;
...
/**
  * Instantiates Module org.infogrid.store (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The InfoGrid Store Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Provides the Store abstraction for storage in InfoGrid,\\n   and some utilities that are useful regardless of the Store implementation chosen."
                                }
                        }),
                        new java.util.Date( 1456080518148L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.store.jar" )
                        },
                        null,
                        null,
