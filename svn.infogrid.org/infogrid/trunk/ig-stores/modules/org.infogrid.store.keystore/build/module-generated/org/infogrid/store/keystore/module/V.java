...
package org.infogrid.store.keystore.module;
...
/**
  * Instantiates Module org.infogrid.store.keystore (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Store-based Java KeyStore Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Maps a Java KeyStore onto the InfoGrid Store abstraction."
                                }
                        }),
                        new java.util.Date( 1456080523869L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.store.keystore.jar" )
                        },
                        null,
                        null,
