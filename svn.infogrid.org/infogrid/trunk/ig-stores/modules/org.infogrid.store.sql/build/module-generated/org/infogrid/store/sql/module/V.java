...
package org.infogrid.store.sql.module;
...
/**
  * Instantiates Module org.infogrid.store.sql (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Implements the Store abstraction using a SQL database"
                                }
                        }),
                        new java.util.Date( 1456080526398L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.store.sql.jar" )
                        },
                        null,
                        null,
