...
package org.infogrid.authp.module;
...
/**
  * Instantiates Module org.infogrid.authp (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Authentication provider (core)"
                                }
                        }),
                        null,
                        new java.util.Date( 1456108648451L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.authp.jar" )
                        },
                        null,
                        null,
