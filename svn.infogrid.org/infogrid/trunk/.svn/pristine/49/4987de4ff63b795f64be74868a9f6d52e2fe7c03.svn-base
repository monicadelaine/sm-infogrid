...
/**
 * Tag that evaluates its content when a <code>MeshObjectSet</code> has a number of
 * members between a lower and an upper limit.
 * @see <a href="package-summary.html">Details in package documentation</a>
 */
public class IfSetContainsTag
    extends
        AbstractSetTestTag
{
