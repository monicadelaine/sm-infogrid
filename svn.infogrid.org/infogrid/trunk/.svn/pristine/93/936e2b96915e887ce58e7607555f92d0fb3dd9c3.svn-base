 ...
 */
public class NetMeshObjectTypeRemovedEvent
        extends
            MeshObjectTypeRemovedEvent
        implements
            NetMeshObjectTypeChangeEvent
{
     ...
     */
    @Override
    public NetMeshObjectTypeAddedEvent inverse()
    {
        return new NetMeshObjectTypeAddedEvent(
            ...
            TransactionException
    {
        ...
        try {
            ...
            if( otherObject != null && incomingProxy == otherObject.getProxyTowardsLockReplica() ) {
                ...
                otherObject.rippleUnbless( types, getTimeEventOccurred() );
            }
            return otherObject;
