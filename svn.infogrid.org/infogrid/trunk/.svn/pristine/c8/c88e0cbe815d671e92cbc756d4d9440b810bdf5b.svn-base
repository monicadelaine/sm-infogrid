...
/**
 * <p>Abstract superclass for tags that perform tests related to the lock of the NetMeshObject.</p>
 */
public abstract class AbstractIfHasLockTag
    extends
        AbstractInfoGridBodyTag
{
     ...
     * Constructor.
     */
    protected AbstractIfHasLockTag()
    {
        // noop
    }
