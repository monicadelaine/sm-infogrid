...
/**
 * Processes content if the caller does not have update access to a given MeshObject.
 */
public class NotHasUpdateAccessTag
        extends
            AbstractUpdateAccessTag
{
