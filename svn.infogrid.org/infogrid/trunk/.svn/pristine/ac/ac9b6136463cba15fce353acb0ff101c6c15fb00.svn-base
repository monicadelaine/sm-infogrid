 ...
 */
public class SqlStoreIteratorTest3
        extends
            AbstractStoreIteratorTest3
{
    ...
    public static void main(
            String [] args )
    {
        SqlStoreIteratorTest3 test = null;
        try {
            if( args.length != 1 ) {
            ...
            test = new SqlStoreIteratorTest3( args );
            test.run();
     ...
     */
    public SqlStoreIteratorTest3(
            String [] args )
        throws
            Exception
    {
        super( localFileName( SqlStoreIteratorTest3.class, "/ResourceHelper" ));
