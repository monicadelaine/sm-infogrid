...
/**
 * <p>Tag that shows the duration since a <code>MeshObject</code> was last read.</p>
 * @see <a href="package-summary.html">Details in package documentation</a>
 */
public class MeshObjectSinceTimeReadTag
    extends
        AbstractMeshObjectDurationTag
{
     ...
     * Constructor.
     */
    public MeshObjectSinceTimeReadTag()
    {
        // noop
    }
