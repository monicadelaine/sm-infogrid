 ...
 */
public class IntegerStringifierTest3
        extends
            AbstractTest
{
    /**
    ...
    public static void main(
             String [] args )
    {
        IntegerStringifierTest3 test = null;
        try {
            ...
            test = new IntegerStringifierTest3( args );
            test.run();
     ...
     * @throws Exception all sorts of things may happen in a test
     */
    public IntegerStringifierTest3(
            String [] args )
        throws
            Exception
    {
    ...
    private static final Log log = Log.getLogInstance( IntegerStringifierTest3.class ); // our own, private logger
}
