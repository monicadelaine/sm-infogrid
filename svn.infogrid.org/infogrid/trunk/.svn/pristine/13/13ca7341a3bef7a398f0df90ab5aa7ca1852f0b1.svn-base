            ...
            AbstractDifferencerTest
{
            ...
            Exception
    {
        ...
        a1_mb1.setPropertyValue( typeU, StringValue.create( "initial") );
            ...
            String [] args )
    {
        ...
        try {
            ...
            test = new DifferencerTest3( args );
            test.run();
    ...
    // Our Logger
    private static Log log = Log.getLogInstance( DifferencerTest3.class );
}
