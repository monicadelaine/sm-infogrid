...
/**
 * <p>Renders the HTML to traverse one level up in a tree outline.</p>
 * @see <a href="package-summary.html">Details in package documentation</a>
 */
public class TreeIterateUpTag
    extends
        AbstractTreeIterateTag
{
            ...
            IgnoreException
    {
        ...
        if( parentTag == null || !( parentTag instanceof TreeIterateTag )) {
            throw new JspException( "TreeIterateUpTag tag must be directly contained in an TreeIterateTag tag" );
        }
