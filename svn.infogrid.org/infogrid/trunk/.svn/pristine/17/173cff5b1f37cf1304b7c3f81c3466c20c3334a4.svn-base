 ...
 * Here the created relationship is between the home replicas.
 */
public class XprisoTest6_5a
    extends
        AbstractXprisoTest
{
    /**
     ...
     * @throws Exception all kinds of things can go wrong in tests
     */
    public XprisoTest6_5a(
            String [] args )
        throws
            Exception
    {
        super( XprisoTest6_5a.class  );
