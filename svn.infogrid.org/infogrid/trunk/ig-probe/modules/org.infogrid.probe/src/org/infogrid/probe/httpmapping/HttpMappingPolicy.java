...
/**
 * Defines how HTTP status codes are mapped into the InfoGrid world.
 * For example, defines whether HTTP 404 "Not Found" cause MeshObjectNotFoundException
 * or whether a MeshObject shall be created.
 */
public interface HttpMappingPolicy
{
    /**
