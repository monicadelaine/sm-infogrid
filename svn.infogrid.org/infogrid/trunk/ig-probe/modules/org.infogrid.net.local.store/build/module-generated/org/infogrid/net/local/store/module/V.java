...
package org.infogrid.net.local.store.module;
...
/**
  * Instantiates Module org.infogrid.net.local.store (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Store for Probe-integrated NetMeshBases Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Enables a Probe-integrated NetMeshBase to persist its content in any InfoGrid Store."
                                }
                        }),
                        new java.util.Date( 1456085424850L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.net.local.store.jar" )
                        },
                        null,
                        null,
