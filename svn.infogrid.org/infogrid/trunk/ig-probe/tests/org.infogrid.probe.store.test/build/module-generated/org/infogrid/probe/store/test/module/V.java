...
package org.infogrid.probe.store.test.module;
...
/**
  * Instantiates Module org.infogrid.probe.store.test (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.probe.store.test",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Store Probe test Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests the persisting of Probe framework information via the InfoGrid Store\\n   abstraction."
                                }
                        }),
                        new java.util.Date( 1456085441196L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.probe.store.test.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.probe.store.test.AllTests",
                        "main" );
