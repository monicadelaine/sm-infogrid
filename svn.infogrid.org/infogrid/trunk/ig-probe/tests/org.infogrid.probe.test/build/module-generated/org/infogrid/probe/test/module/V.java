...
package org.infogrid.probe.test.module;
...
/**
  * Instantiates Module org.infogrid.probe.test (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests the InfoGrid Probe framework."
                                }
                        }),
                        new java.util.Date( 1456085427237L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/probe/test/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.probe.test.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.probe.test.AllTests",
                        "main" );
