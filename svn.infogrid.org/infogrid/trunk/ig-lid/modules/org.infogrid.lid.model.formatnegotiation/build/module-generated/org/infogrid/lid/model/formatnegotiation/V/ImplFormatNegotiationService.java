...
import org.infogrid.lid.model.formatnegotiation.*;

/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.formatnegotiation/FormatNegotiationService.</p>
...
public class ImplFormatNegotiationService
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.formatnegotiation.FormatNegotiationService

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplFormatNegotiationService.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplFormatNegotiationService(
            MeshObject delegate )
    {
        super( delegate );
    }
