...
package org.infogrid.lid.model.formatnegotiation.V;
...
/**
  * This class loads the model of the LID Format Negotiation Subject Area Subject Area.
  */
            ...
            ModelLoader
{
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        ...
        SubjectArea theSa = theInstantiator.createSubjectArea(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.lid.model.formatnegotiation" ),   // IdentifierValue           theIdentifier,
                org.infogrid.model.primitives.StringValue.create( "org.infogrid.lid.model.formatnegotiation" ),   // StringValue               theName,
                null,   // StringValue               theVersion,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "LID Format Negotiation Subject Area" ) ),   // L10Map                    theUserNames,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "Supports LID format negotiation." , "text/html" ) ),   // L10Map                    theUserDescriptions,
        ...
        EntityType obj0 = theInstantiator.createEntityType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.lid.model.formatnegotiation/FormatNegotiationService" ),
                org.infogrid.model.primitives.StringValue.create( "FormatNegotiationService" ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "Format Negotiation Service" ) ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "A Yadis Service to negotiate the format of responses." , "text/html" ) ),
                null,
                theSa,
...
theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "http://lid.netmesh.org/format-negotiation/2.0" )},
                null,
                new String[] {},
                new StringValue[0],
                new StringValue[0],
