...
package org.infogrid.lid.model.formatnegotiation.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.formatnegotiation (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.lid.model.formatnegotiation",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "LID Format Negotiation Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080664746L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.formatnegotiation.jar" )
                        },
                        null,
                        null );
