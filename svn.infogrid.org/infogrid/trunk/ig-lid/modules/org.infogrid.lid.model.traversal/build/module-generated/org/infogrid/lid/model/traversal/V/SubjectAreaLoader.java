...
/**
  * This class loads the model of the LID Traversal Subject Area Subject Area.
  */
            ...
            ModelLoader
{
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        ...
        SubjectArea theSa = theInstantiator.createSubjectArea(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.lid.model.traversal" ),   // IdentifierValue           theIdentifier,
                org.infogrid.model.primitives.StringValue.create( "org.infogrid.lid.model.traversal" ),   // StringValue               theName,
                null,   // StringValue               theVersion,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "LID Traversal Subject Area" ) ),   // L10Map                    theUserNames,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "Supports LID traversals and selections." , "text/html" ) ),   // L10Map                    theUserDescriptions,
        ...
        EntityType obj0 = theInstantiator.createEntityType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.lid.model.traversal/TraversalService2" ),
                org.infogrid.model.primitives.StringValue.create( "TraversalService2" ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "TraversalService2" ) ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "A Yadis Service to traverse from one object to zero, one or more others." , "text/html" ) ),
                null,
                theSa,
...
theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "http://lid.netmesh.org/traversal/2.0" )},
                null,
                new String[] {},
                new StringValue[0],
                new StringValue[0],
