...
package org.infogrid.lid.model.traversal.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.traversal (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.lid.model.traversal",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "LID Traversal Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080661856L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.traversal.jar" )
                        },
                        null,
                        null );
