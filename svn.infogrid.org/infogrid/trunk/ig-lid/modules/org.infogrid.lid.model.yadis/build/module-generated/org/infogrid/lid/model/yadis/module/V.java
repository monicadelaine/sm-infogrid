...
package org.infogrid.lid.model.yadis.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.yadis (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        null,
                        new java.util.Date( 1456080633154L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.yadis.jar" )
                        },
                        null,
                        null );
