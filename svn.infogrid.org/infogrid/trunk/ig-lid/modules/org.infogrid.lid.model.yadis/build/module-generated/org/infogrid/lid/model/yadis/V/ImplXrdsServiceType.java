...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.yadis/XrdsServiceType.</p>
...
public class ImplXrdsServiceType
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.yadis.XrdsServiceType

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplXrdsServiceType.class ); // our own, private logger
    ...
    /**
      * Set value for property ServiceTypeIdentifier.
      *
            ...
            org.infogrid.meshbase.transaction.TransactionException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setServiceTypeIdentifier", newValue );
        }

        try {
            the_Delegate.setPropertyValue( SERVICETYPEIDENTIFIER, newValue );
    ...
    /**
      * Obtain value for property ServiceTypeIdentifier.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.StringValue getServiceTypeIdentifier()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.StringValue) the_Delegate.getPropertyValue( SERVICETYPEIDENTIFIER );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
