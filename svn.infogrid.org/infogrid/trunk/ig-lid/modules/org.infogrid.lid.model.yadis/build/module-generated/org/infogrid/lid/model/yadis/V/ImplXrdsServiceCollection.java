...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.yadis/XrdsServiceCollection.</p>
...
public class ImplXrdsServiceCollection
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.yadis.XrdsServiceCollection

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplXrdsServiceCollection.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplXrdsServiceCollection(
            MeshObject delegate )
    {
        super( delegate );
    }
    ...
    /**
      * Set value for property XrdsResourceContent.
      *
      ...
      */
    public void setXrdsResourceContent(
            ...
            org.infogrid.mesh.IllegalPropertyValueException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setXrdsResourceContent", newValue );
        }

        try {
            the_Delegate.setPropertyValue( XRDSRESOURCECONTENT, newValue );
    ...
    /**
      * Obtain value for property XrdsResourceContent.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.BlobValue getXrdsResourceContent()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.BlobValue) the_Delegate.getPropertyValue( XRDSRESOURCECONTENT );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
