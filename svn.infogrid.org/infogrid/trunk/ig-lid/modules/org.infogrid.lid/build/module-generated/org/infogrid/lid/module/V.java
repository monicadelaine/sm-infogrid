...
package org.infogrid.lid.module;
...
/**
  * Instantiates Module org.infogrid.lid (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Basic framework for Light-Weight Identity."
                                }
                        }),
                        new java.util.Date( 1456080626443L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.jar" )
                        },
                        null,
                        null,
