...
package org.infogrid.lid.model.openid.pape.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.openid.pape (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.lid.model.openid.pape",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "OpenID Provider Authentication Policy Extension Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080655846L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.openid.pape.jar" )
                        },
                        null,
                        null );
