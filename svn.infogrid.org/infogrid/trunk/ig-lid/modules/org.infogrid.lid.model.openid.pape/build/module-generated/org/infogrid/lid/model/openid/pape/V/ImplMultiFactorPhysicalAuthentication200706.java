...
package org.infogrid.lid.model.openid.pape.V;

import org.infogrid.model.primitives.*;
import org.infogrid.mesh.*;
import org.infogrid.lid.model.openid.pape.*;

/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.openid.pape/MultiFactorPhysicalAuthentication200706.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.openid.pape/MultiFactorPhysicalAuthentication200706</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>MultiFactorPhysicalAuthentication200706</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>Multi-factor authentication including at least one physical factor</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>This service is provided by OpenID Providers that offer one or more\nforms of authentication that require more than one factor, at least one of which is a physical\nfactor such as a hardware device.</td></tr></table></td></tr>
  * </table>
  */

public class ImplMultiFactorPhysicalAuthentication200706
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.openid.pape.MultiFactorPhysicalAuthentication200706

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMultiFactorPhysicalAuthentication200706.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMultiFactorPhysicalAuthentication200706(
            MeshObject delegate )
    {
        super( delegate );
    }
