...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.openid.pape/MultiFactorAuthentication200706.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.openid.pape/MultiFactorAuthentication200706</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>MultiFactorAuthentication200706</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>Multi-factor Authentication</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>This service is provided by OpenID Providers that offer one or more\nforms of authentication that require more than one factor.</td></tr></table></td></tr>
  * </table>
  */

public class ImplMultiFactorAuthentication200706
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.openid.pape.MultiFactorAuthentication200706

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMultiFactorAuthentication200706.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMultiFactorAuthentication200706(
            MeshObject delegate )
    {
        super( delegate );
    }
