...
package org.infogrid.lid.ldap.module;
...
/**
  * Instantiates Module org.infogrid.lid.ldap (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.lid.ldap",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "LDAP support for InfoGrid LID"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Provides a LidIdentityServer implemented through LDAP."
                                }
                        }),
                        new java.util.Date( 1456080667296L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.ldap.jar" )
                        },
                        null,
                        null,
