...
package org.infogrid.lid.model.post.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.post (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.lid.model.post",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "LID Messaging Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080658962L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.post.jar" )
                        },
                        null,
                        null );
