...
package org.infogrid.lid.model.openid.auth.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.openid.auth (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "OpenID Authentication Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080648134L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.openid.auth.jar" )
                        },
                        null,
                        null );
