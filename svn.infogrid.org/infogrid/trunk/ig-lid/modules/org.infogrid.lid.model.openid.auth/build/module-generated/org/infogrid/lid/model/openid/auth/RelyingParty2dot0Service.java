...
/**
  * <p>Java interface for EntityType org.infogrid.lid.model.openid.auth/RelyingParty2dot0Service.</p>
...
public interface RelyingParty2dot0Service
        extends
            org.infogrid.lid.model.openid.auth.RelyingPartyService
{
    ...
    /**
      * This MeshType.
      */
    public static final EntityType _TYPE = ModelBaseSingleton.findEntityType( "org.infogrid.lid.model.openid.auth/RelyingParty2dot0Service" );
