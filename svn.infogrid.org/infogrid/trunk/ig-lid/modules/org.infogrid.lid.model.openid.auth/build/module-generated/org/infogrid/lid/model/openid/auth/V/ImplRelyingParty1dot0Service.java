...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.openid.auth/RelyingParty1dot0Service.</p>
...
public class ImplRelyingParty1dot0Service
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.openid.auth.RelyingParty1dot0Service

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplRelyingParty1dot0Service.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplRelyingParty1dot0Service(
            MeshObject delegate )
    {
        super( delegate );
    }
