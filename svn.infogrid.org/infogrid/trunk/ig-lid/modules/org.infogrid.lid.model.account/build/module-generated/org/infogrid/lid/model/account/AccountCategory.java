...
/**
  * <p>Java interface for EntityType org.infogrid.lid.model.account/AccountCategory.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.account/AccountCategory</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>AccountCategory</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>Account Category</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>Categorizes accounts into categories</td></tr></table></td></tr>
  * </table>
  */
            ...
            org.infogrid.mesh.TypedMeshObjectFacade
{
    ...
    /**
      * This MeshType.
      */
    public static final EntityType _TYPE = ModelBaseSingleton.findEntityType( "org.infogrid.lid.model.account/AccountCategory" );

    /**
      * This MeshType.
      */
    public static final RoleType _AccountCategory_Categorizes_Account_SOURCE = ModelBaseSingleton.findRoleType( "org.infogrid.lid.model.account/AccountCategory_Categorizes_Account-S" );

    /**
      * <p>Set value for property Name.</p>
      *
      * <table>
      *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.account/AccountCategory_Name</tt></td></tr>
      ...
      *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>Name of the category.</td></tr></table></td></tr>
      * </table>
      *
    ...
    /**
      ...
      */
    public static final PropertyType NAME = ModelBaseSingleton.findPropertyType( "org.infogrid.lid.model.account/AccountCategory_Name" );
