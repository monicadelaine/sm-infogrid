...
package org.infogrid.lid.store.module;
...
/**
  * Instantiates Module org.infogrid.lid.store (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.lid.store",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Store support for the InfoGrid LID implementation"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Enables LID information to be stored via any InfoGrid Store."
                                }
                        }),
                        new java.util.Date( 1456080671883L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.store.jar" )
                        },
                        null,
                        null,
