...
package org.infogrid.lid.model.lid.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.lid (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        null,
                        new java.util.Date( 1456080644079L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.lid.jar" )
                        },
                        null,
                        null );
