...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.lid/RelyingPartyService.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.lid/RelyingPartyService</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>RelyingPartyService</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>RelyingPartyService</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>A Yadis Service that is able to accept authentication assertions. More specific subclasses\nare provided for specific protocols.</td></tr></table></td></tr>
  * </table>
  */

public class ImplRelyingPartyService
        extends
...
{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplRelyingPartyService.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplRelyingPartyService(
            MeshObject delegate )
    {
        super( delegate );
    }
