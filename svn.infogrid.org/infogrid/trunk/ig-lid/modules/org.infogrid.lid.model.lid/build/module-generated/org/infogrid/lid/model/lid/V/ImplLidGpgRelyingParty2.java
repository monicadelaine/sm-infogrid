...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.lid/LidGpgRelyingParty2.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.lid.model.lid/LidGpgRelyingParty2</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>LidGpgRelyingParty2</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>LID\'s GPG-based Relying Party Service (version 2)</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>A LID GPG-based Relying Party Service based on the LID GPG SSO service, version 2.</td></tr></table></td></tr>
  * </table>
  */

public class ImplLidGpgRelyingParty2
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.lid.LidGpgRelyingParty2

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplLidGpgRelyingParty2.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplLidGpgRelyingParty2(
            MeshObject delegate )
    {
        super( delegate );
    }
