...
/**
  * <p>Java implementation class for EntityType org.infogrid.lid.model.xrd/LinkTemplate.</p>
...
public class ImplLinkTemplate
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.lid.model.xrd.LinkTemplate

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplLinkTemplate.class ); // our own, private logger
    ...
    /**
      * Set value for property Template.
      *
            ...
            org.infogrid.meshbase.transaction.TransactionException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setTemplate", newValue );
        }

        try {
            the_Delegate.setPropertyValue( TEMPLATE, newValue );
    ...
    /**
      * Obtain value for property Template.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.StringValue getTemplate()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.StringValue) the_Delegate.getPropertyValue( TEMPLATE );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
