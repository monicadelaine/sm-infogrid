...
package org.infogrid.lid.openid.module;
...
/**
  * Instantiates Module org.infogrid.lid.openid (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid LID OpenID support"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Supports OpenID as part of Light-Weight Identity."
                                }
                        }),
                        new java.util.Date( 1456080629908L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.openid.jar" )
                        },
                        null,
                        null,
