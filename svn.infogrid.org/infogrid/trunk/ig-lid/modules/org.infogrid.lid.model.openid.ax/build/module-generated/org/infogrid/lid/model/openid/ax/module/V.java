...
package org.infogrid.lid.model.openid.ax.module;
...
/**
  * Instantiates Module org.infogrid.lid.model.openid.ax (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.lid.model.openid.ax",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "OpenID Attribute Exchange Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080652136L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.lid.model.openid.ax.jar" )
                        },
                        null,
                        null );
