...
package org.infogrid.jee.viewlet.log4j.module;
...
/**
  * Instantiates Module org.infogrid.jee.viewlet.log4j (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Viewlet for log4j configuration."
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Enables the user to change the log4j configuration at run-time."
                                }
                        }),
                        new java.util.Date( 1456085491492L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.viewlet.log4j.jar" )
                        },
                        null,
                        null,
