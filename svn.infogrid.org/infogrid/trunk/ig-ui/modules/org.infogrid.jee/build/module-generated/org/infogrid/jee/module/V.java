...
package org.infogrid.jee.module;
...
/**
  * Instantiates Module org.infogrid.jee (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "JEE support for InfoGrid."
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Frameworks and components that make the development of InfoGrid applications\\n   using JEE easier."
                                }
                        }),
                        new java.util.Date( 1456085460776L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.jar" )
                        },
                        null,
                        null,
