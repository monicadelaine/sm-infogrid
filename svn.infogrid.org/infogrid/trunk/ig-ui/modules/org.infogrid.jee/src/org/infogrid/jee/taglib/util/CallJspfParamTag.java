...
/**
 * Sets the value of a parameter to a Jspf call to a particular value for this invocation.
 * @see <a href="package-summary.html">Details in package documentation</a>
 */
public class CallJspfParamTag
    extends
        AbstractInfoGridTag

{
    ...
    protected int realDoStartTag()
        throws
            ...
            IOException
    {
        Tag parentTag = findAncestorTag( CallJspfTag.class );
        if( parentTag == null ) {
            throw new JspException( "CallJspfParamTag must be contained in a CallJspfTag" );
        }
