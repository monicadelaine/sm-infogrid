...
/**
 * <p>Abstract superclass for tags that perform tests about whether a NetMeshObject
 *    will give up the lock, should it have it.</p>
 */
public abstract class AbstractIfWillGiveUpLockTag
    extends
        AbstractInfoGridBodyTag
{
     ...
     * Constructor.
     */
    protected AbstractIfWillGiveUpLockTag()
    {
        // noop
    }
            ...
            IgnoreException
    {
        ...
        boolean ret = obj.getWillGiveUpLock();
