...
package org.infogrid.jee.viewlet.net.local.store.module;
...
/**
  * Instantiates Module org.infogrid.jee.viewlet.net.local.store (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "JEE/REST Store Net support for InfoGrid."
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Makes developing REST-ful, net-based applications based on Store with InfoGrid easier."
                                }
                        }),
                        new java.util.Date( 1456085477450L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.viewlet.net.local.store.jar" )
                        },
                        null,
                        null,
