...
package org.infogrid.jee.security.aclbased.module;
...
/**
  * Instantiates Module org.infogrid.jee.security.aclbased (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.jee.security.aclbased",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tags to support ACL-based security."
                                }
                        }),
                        null,
                        new java.util.Date( 1456085486960L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.security.aclbased.jar" )
                        },
                        null,
                        null,
