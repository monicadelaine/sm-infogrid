...
package org.infogrid.jee.probe.module;
...
/**
  * Instantiates Module org.infogrid.jee.probe (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "JEE/REST support the InfoGrid Probe framework."
                                }
                        }),
                        null,
                        new java.util.Date( 1456085473030L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.probe.jar" )
                        },
                        null,
                        null,
