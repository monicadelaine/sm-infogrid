...
package org.infogrid.jee.viewlet.bulk.module;
...
/**
  * Instantiates Module org.infogrid.jee.viewlet.bulk (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "A Viewlet that enables the user to bulk-load InfoGrid data."
                                }
                        }),
                        new java.util.Date( 1456085489301L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.viewlet.bulk.jar" )
                        },
                        null,
                        null,
