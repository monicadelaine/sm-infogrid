...
/**
  * This class loads the model of the Viewlet Subject Area Subject Area.
  */
            ...
            ModelLoader
{
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        ...
        SubjectArea theSa = theInstantiator.createSubjectArea(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.model.Viewlet" ),   // IdentifierValue           theIdentifier,
                org.infogrid.model.primitives.StringValue.create( "org.infogrid.model.Viewlet" ),   // StringValue               theName,
                null,   // StringValue               theVersion,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "Viewlet Subject Area" ) ),   // L10Map                    theUserNames,
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "A model to support the Viewlet framework." , "text/html" ) ),   // L10Map                    theUserDescriptions,
        ...
        EntityType obj0 = theInstantiator.createEntityType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.model.Viewlet/ViewletPreference" ),
                org.infogrid.model.primitives.StringValue.create( "ViewletPreference" ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "Viewlet Preference" ) ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "Enables any MeshObject to express its preference of Viewlet type for rendering." , "text/html" ) ),
                null,
                theSa,
        ...
        PropertyType obj0_pt0 = theInstantiator.createPropertyType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.model.Viewlet/ViewletPreference_ViewletType" ),
                org.infogrid.model.primitives.StringValue.create( "ViewletType" ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "Viewlet Type" ) ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "Name of the Viewlet Type that should be used to render this MeshObject" , "text/html" ) ),
                obj0,
                theSa,
                obj0_pt0_type,
                null,
