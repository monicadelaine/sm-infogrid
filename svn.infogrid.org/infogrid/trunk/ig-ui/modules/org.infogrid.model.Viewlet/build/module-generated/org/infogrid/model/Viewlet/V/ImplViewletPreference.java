...
package org.infogrid.model.Viewlet.V;

import org.infogrid.model.primitives.*;
import org.infogrid.mesh.*;
import org.infogrid.model.Viewlet.*;

/**
  * <p>Java implementation class for EntityType org.infogrid.model.Viewlet/ViewletPreference.</p>
...
public class ImplViewletPreference
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Viewlet.ViewletPreference

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplViewletPreference.class ); // our own, private logger
    ...
    /**
      * Set value for property ViewletType.
      *
            ...
            org.infogrid.meshbase.transaction.TransactionException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setViewletType", newValue );
        }

        try {
            the_Delegate.setPropertyValue( VIEWLETTYPE, newValue );
    ...
    /**
      * Obtain value for property ViewletType.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.StringValue getViewletType()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.StringValue) the_Delegate.getPropertyValue( VIEWLETTYPE );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
