...
package org.infogrid.jee.templates.module;
...
/**
  * Instantiates Module org.infogrid.jee.templates (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid templating system"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The InfoGrid templating system."
                                }
                        }),
                        new java.util.Date( 1456085463918L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.templates.jar" )
                        },
                        null,
                        null,
