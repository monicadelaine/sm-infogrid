...
package org.infogrid.jee.viewlet.net.local.module;
...
/**
  * Instantiates Module org.infogrid.jee.viewlet.net.local (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "JEE/REST Net support for InfoGrid."
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Makes developing REST-ful, net-based applications with InfoGrid easier."
                                }
                        }),
                        new java.util.Date( 1456085475224L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.viewlet.net.local.jar" )
                        },
                        null,
                        null,
