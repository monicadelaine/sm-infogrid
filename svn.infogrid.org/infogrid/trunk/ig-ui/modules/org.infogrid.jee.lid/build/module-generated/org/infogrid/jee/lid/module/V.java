...
package org.infogrid.jee.lid.module;
...
/**
  * Instantiates Module org.infogrid.jee.lid (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.jee.lid",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "JEE/REST support for InfoGrid LID."
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Makes developing LID and OpenID-enabled applications with InfoGrid Networked easier."
                                }
                        }),
                        new java.util.Date( 1456085484620L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.lid.jar" )
                        },
                        null,
                        null,
