...
package org.infogrid.viewlet.module;
...
/**
  * Instantiates Module org.infogrid.viewlet (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Defines the InfoGrid Viewlet framework for showing MeshObjects on screen."
                                }
                        }),
                        new java.util.Date( 1456085458277L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.viewlet.jar" )
                        },
                        null,
                        null,
