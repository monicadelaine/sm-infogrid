...
package org.infogrid.jee.viewlet.module.module;
...
/**
  * Instantiates Module org.infogrid.jee.viewlet.module (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Enables the user to inspect the content of the Module Directory."
                                }
                        }),
                        new java.util.Date( 1456085493740L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.jee.viewlet.module.jar" )
                        },
                        null,
                        null,
