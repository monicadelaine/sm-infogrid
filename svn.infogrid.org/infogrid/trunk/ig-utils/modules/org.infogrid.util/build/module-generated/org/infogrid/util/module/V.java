...
package org.infogrid.util.module;
...
/**
  * Instantiates Module org.infogrid.util (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid utility module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Contains utility classes and methods that are generally useful."
                                }
                        }),
                        new java.util.Date( 1458517569687L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.util.jar" )
                        },
                        null,
                        null,
