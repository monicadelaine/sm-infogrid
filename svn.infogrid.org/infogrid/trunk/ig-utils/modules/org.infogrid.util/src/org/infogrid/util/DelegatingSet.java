            ...
            Set<E>
{
    ...
    {
        return new DelegatingSet<E>( delegates );
    }
    ...
    public static <E> DelegatingSet<E> create(
            Set<E> [] delegates )
    {
        List<Set<E>> delegates2 = new ArrayList<Set<E>>( delegates.length );
        for( int i=0 ; i<delegates.length ; ++i ) {
            delegates2.add( delegates[i] );
        }
        return new DelegatingSet<E>( delegates2 );
    }
    ...
    public static <E> DelegatingSet<E> create(
            ...
            Set<E> del2 )
    {
        List<Set<E>> delegates2 = new ArrayList<Set<E>>( 2 );
        delegates2.add( del1 );
        delegates2.add( del2 );
