...
package org.infogrid.comm.module;
...
/**
  * Instantiates Module org.infogrid.comm (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Abstract Communications Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The Communications Module provides the abstract notions of\\n   communications endpoints that can send messages to each other.\\n   It also implements RPC-style call-response patterns on top."
                                }
                        }),
                        new java.util.Date( 1456080476376L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.comm.jar" )
                        },
                        null,
                        null,
