...
package org.infogrid.comm.pingpong.module;
...
/**
  * Instantiates Module org.infogrid.comm.pingpong (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The PingPong Communications Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Implements the abstract Communications Module with a ping-pong\\n  (token-based) handshake approach."
                                }
                        }),
                        new java.util.Date( 1456080478867L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.comm.pingpong.jar" )
                        },
                        null,
                        null,
