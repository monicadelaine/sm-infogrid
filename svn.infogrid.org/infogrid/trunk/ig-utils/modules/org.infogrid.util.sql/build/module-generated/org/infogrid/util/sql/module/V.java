...
package org.infogrid.util.sql.module;
...
/**
  * Instantiates Module org.infogrid.util.sql (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid SQL Database Abstraction"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080474017L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.util.sql.jar" )
                        },
                        null,
                        null,
