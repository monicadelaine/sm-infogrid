...
package org.infogrid.httpd.filesystem.module;
...
/**
  * Instantiates Module org.infogrid.httpd.filesystem (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.httpd.filesystem",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Simple HTTP file system server"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The minimalistic HTTP server serving files from the file system"
                                }
                        }),
                        new java.util.Date( 1456080489484L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.httpd.filesystem.jar" )
                        },
                        null,
                        null,
