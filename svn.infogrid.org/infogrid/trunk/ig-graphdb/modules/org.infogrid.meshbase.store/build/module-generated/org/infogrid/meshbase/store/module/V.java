...
package org.infogrid.meshbase.store.module;
...
/**
  * Instantiates Module org.infogrid.meshbase.store (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Store MeshBase module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Enables the content of a MeshBase to be persisted in any InfoGrid Store."
                                }
                        }),
                        new java.util.Date( 1456080556052L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.meshbase.store.jar" )
                        },
                        null,
                        null,
