...
package org.infogrid.kernel.active.module;
...
/**
  * Instantiates Module org.infogrid.kernel.active (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Active InfoGrid kernel"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Defines ActiveSets and related concepts."
                                }
                        }),
                        new java.util.Date( 1456080550181L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.kernel.active.jar" )
                        },
                        null,
                        null,
