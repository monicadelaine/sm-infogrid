...
package org.infogrid.kernel.module;
...
/**
  * Instantiates Module org.infogrid.kernel (no specific version given).
  */
public class V
    implements
        ...
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        ...
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Contains all foundation InfoGrid frameworks and concepts and simple implementations."
                                }
                        }),
                        new java.util.Date( 1458517748599L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.kernel.jar" )
                        },
                        null,
                        null,
