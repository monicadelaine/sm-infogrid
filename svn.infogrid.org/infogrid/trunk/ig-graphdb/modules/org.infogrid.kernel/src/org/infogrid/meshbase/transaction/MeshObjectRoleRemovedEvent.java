            ...
            AbstractMeshObjectRoleChangeEvent
{
     ...
     */
    public MeshObjectRoleAddedEvent inverse()
    {
        return new MeshObjectRoleAddedEvent(
                getSource(),
                getNewValue(),
                getDeltaValue(),
                getOldValue(),
    ...
    public boolean isInverse(
            Change candidate )
    {
        if( !( candidate instanceof MeshObjectRoleAddedEvent )) {
            return false;
        }
        ...
        MeshObjectRoleAddedEvent realCandidate = (MeshObjectRoleAddedEvent) candidate;
