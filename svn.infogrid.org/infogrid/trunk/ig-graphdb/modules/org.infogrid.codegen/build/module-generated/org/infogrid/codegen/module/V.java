...
package org.infogrid.codegen.module;
...
/**
  * Instantiates Module org.infogrid.codegen (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.codegen",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "InfoGrid code generator"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "The InfoGrid code generator generates interfaces, implementation\\n   classes, and documentation from models."
                                }
                        }),
                        new java.util.Date( 1458517353669L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/codegen/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.codegen.jar" )
                        },
                        null,
                        null,
                        new ModuleCapability[] {
                        },
                        "org.infogrid.codegen.CodeGenerator",
                        "activate",
                        "deactivate",
                        null,
                        "configure",
