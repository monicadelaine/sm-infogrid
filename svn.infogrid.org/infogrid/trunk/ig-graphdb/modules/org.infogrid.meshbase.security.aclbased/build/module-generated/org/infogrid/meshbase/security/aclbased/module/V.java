...
package org.infogrid.meshbase.security.aclbased.module;
...
/**
  * Instantiates Module org.infogrid.meshbase.security.aclbased (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        ...
                        null,
                        new java.util.Date( 1456080558874L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.meshbase.security.aclbased.jar" )
                        },
                        null,
                        null );
