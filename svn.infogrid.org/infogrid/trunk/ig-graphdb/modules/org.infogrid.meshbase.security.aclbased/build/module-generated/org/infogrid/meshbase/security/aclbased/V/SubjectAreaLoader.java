...
package org.infogrid.meshbase.security.aclbased.V;
            ...
            ModelLoader
{
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        ...
        SubjectArea theSa = theInstantiator.createSubjectArea(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased" ),   // IdentifierValue           theIdentifier,
                org.infogrid.model.primitives.StringValue.create( "org.infogrid.meshbase.security.aclbased" ),   // StringValue               theName,
        ...
        EntityType obj0 = theInstantiator.createEntityType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/ProtectionDomain" ),
        ...
        RelationshipType obj1 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasOwner_MeshObject" ),
        ...
        RelationshipType obj4 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/ProtectionDomain_Governs_MeshObject" ),
                ...
                theModelBase.findEntityTypeByIdentifier( theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/ProtectionDomain" ) ),
                null,
                new RoleType[] { },  
                new RoleType[] { },  
                new String[] {}, 
        ...
        RelationshipType obj7 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasAccessTo_ProtectionDomain" ),
        ...
        RelationshipType obj10 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasReadAccessTo_ProtectionDomain" ),
                ...
                null,
                theModelBase.findEntityTypeByIdentifier( theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/ProtectionDomain" ) ),
                new RoleType[] { ((RelationshipType) theModelBase.findMeshTypeByIdentifier( theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasAccessTo_ProtectionDomain" ) )).getSource() },  
                new RoleType[] { ((RelationshipType) theModelBase.findMeshTypeByIdentifier( theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasAccessTo_ProtectionDomain" ) )).getDestination() },  
                new String[] {}, 
                new String[] {}, 
                org.infogrid.model.primitives.BooleanValue.FALSE,  
                org.infogrid.model.primitives.BooleanValue.TRUE,  
        ...
        RelationshipType obj13 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasUpdateAccessTo_ProtectionDomain" ),
        ...
        RelationshipType obj16 = theInstantiator.createRelationshipType(
                theModelBase.getMeshTypeIdentifierFactory().fromExternalForm( "org.infogrid.meshbase.security.aclbased/MeshObject_HasDeleteAccessTo_ProtectionDomain" ),
                org.infogrid.model.primitives.StringValue.create( "MeshObject_HasDeleteAccessTo_ProtectionDomain" ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.StringValue.create( "may delete" ) ),
                org.infogrid.model.primitives.L10PropertyValueMapImpl.create( org.infogrid.model.primitives.BlobDataType.theTextAnyType.createBlobValue( "This RelationshipType is used to indicate delete access. If no delete access has been\n              allowed to anybody (i.e. the ProtectionDomain does not participate in this relationship), only the owner\n              of the MeshObject has delete access. Regardless what other rules may be defined, the owner of a MeshObject\n              always has delete access." , "text/html" ) ),
                theSa,
                org.infogrid.model.primitives.MultiplicityValue.create( 0, org.infogrid.model.primitives.MultiplicityValue.N ),  
                org.infogrid.model.primitives.MultiplicityValue.create( 0, org.infogrid.model.primitives.MultiplicityValue.N ),  
                null,
