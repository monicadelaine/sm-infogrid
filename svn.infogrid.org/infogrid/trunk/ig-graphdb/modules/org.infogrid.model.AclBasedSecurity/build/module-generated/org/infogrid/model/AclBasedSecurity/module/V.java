...
package org.infogrid.model.AclBasedSecurity.module;
...
/**
  * Instantiates Module org.infogrid.model.AclBasedSecurity (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = ModelModuleAdvertisement.create1(
                        "org.infogrid.model.AclBasedSecurity",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Acl-based Security Subject Area"
                                }
                        }),
                        null,
                        new java.util.Date( 1456080561804L ),
                        null,
                        null,
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.model.AclBasedSecurity.jar" )
                        },
                        null,
                        null );
