...
package org.infogrid.meshbase.store.test.module;
...
/**
  * Instantiates Module org.infogrid.meshbase.store.test (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.meshbase.store.test",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "StoreMeshBase test Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests persisting MeshBase information in Stores."
                                }
                        }),
                        new java.util.Date( 1456080584547L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/meshbase/store/test/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.meshbase.store.test.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.meshbase.store.test.AllTests",
                        "main" );
