...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/MandatoryBlobPlainOrHtml.</p>
...
public class ImplMandatoryBlobPlainOrHtml
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Test.MandatoryBlobPlainOrHtml

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMandatoryBlobPlainOrHtml.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMandatoryBlobPlainOrHtml(
            MeshObject delegate )
    {
        super( delegate );
    }
