...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/MandatoryBlobAny.</p>
...
public class ImplMandatoryBlobAny
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Test.MandatoryBlobAny

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMandatoryBlobAny.class ); // our own, private logger
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        init.setPropertyValues(
                new PropertyType[] {
                    MANDATORYBLOBDATATYPE,
                },
                new PropertyValue[] {
                    MANDATORYBLOBDATATYPE_type.createBlobValue( "DEFAULT VALUE" , "text/plain" ),
                },
                timeUpdated );
    }

    /**
      * Set value for property MandatoryBlobDataType.
      *
      ...
      */
    public void setMandatoryBlobDataType(
            ...
            org.infogrid.mesh.IllegalPropertyValueException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setMandatoryBlobDataType", newValue );
        }

        try {
            the_Delegate.setPropertyValue( MANDATORYBLOBDATATYPE, newValue );
    ...
    /**
      * Obtain value for property MandatoryBlobDataType.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.BlobValue getMandatoryBlobDataType()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.BlobValue) the_Delegate.getPropertyValue( MANDATORYBLOBDATATYPE );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
