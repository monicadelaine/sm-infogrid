...
/**
  * <p>Java interface for EntityType org.infogrid.model.Test/SimpleBlobTest.</p>
  ...
  *
  * <table>
  *  <tr><td>Identifier:</td><td><tt>org.infogrid.model.Test/SimpleBlobTest</tt></td></tr>
  *  <tr><td>Name:</td><td><tt>SimpleBlobTest</tt></td></tr>
  *  <tr><td>IsAbstract:</td><td><code>false</code></td></tr>
  *  <tr><td>UserVisibleName:</td><td><table><tr><td>default locale:</td><td>SimpleBlobTest</td></tr></table></td></tr>
  *  <tr><td>UserVisibleDescription:</td><td><table><tr><td>default locale:</td><td>Holds a single BlobValue. For GUI testing.</td></tr></table></td></tr>
  * </table>
  */

public interface SimpleBlobTest
        extends
            org.infogrid.mesh.TypedMeshObjectFacade
{
    ...
    /**
      * This MeshType.
      */
    public static final EntityType _TYPE = ModelBaseSingleton.findEntityType( "org.infogrid.model.Test/SimpleBlobTest" );

    /**
      * <p>Set value for property AnyOptional.</p>
      *
      * <table>
      *  <tr><td>Identifier:</td><td><tt>org.infogrid.model.Test/SimpleBlobTest_AnyOptional</tt></td></tr>
    ...
    /**
      ...
      */
    public static final PropertyType ANYOPTIONAL = ModelBaseSingleton.findPropertyType( "org.infogrid.model.Test/SimpleBlobTest_AnyOptional" );
