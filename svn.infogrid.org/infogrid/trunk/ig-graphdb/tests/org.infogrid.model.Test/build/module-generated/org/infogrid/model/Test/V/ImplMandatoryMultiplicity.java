...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/MandatoryMultiplicity.</p>
...
public class ImplMandatoryMultiplicity
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Test.MandatoryMultiplicity

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMandatoryMultiplicity.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMandatoryMultiplicity(
            MeshObject delegate )
    {
        super( delegate );
    }
