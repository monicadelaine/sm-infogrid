...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/B.</p>
...
public class ImplB
        ...
        implements
            org.infogrid.model.Test.B

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplB.class ); // our own, private logger
            ...
            org.infogrid.model.primitives.UnknownEnumeratedValueException
    {
        init.setPropertyValues(
                ...
                new PropertyValue[] {
                    Z_type.select( "Value2" ),
                },
                timeUpdated );
    }

    /**
      * Set value for property Z.
      *
            ...
            org.infogrid.mesh.IllegalPropertyValueException
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setZ", newValue );
        }

        try {
            the_Delegate.setPropertyValue( Z, newValue );
    ...
    /**
      * Obtain value for property Z.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.EnumeratedValue getZ()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.EnumeratedValue) the_Delegate.getPropertyValue( Z );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
    ...
    {
        if( log.isTraceEnabled() ) {
            log.traceMethodCallEntry( this, "setU", newValue );
        }

        try {
            the_Delegate.setPropertyValue( U, newValue );
    ...
    /**
      * Obtain value for property U.
      *
      * @return the current value of the property
      * @throws NotPermittedException thrown if this caller did not have permission to perform this operation
      */
    public org.infogrid.model.primitives.StringValue getU()
        throws
            org.infogrid.mesh.NotPermittedException
    {
        try {
            return (org.infogrid.model.primitives.StringValue) the_Delegate.getPropertyValue( U );
        } catch( IllegalPropertyTypeException ex ) {
            log.error( ex );
            return null;
        }
