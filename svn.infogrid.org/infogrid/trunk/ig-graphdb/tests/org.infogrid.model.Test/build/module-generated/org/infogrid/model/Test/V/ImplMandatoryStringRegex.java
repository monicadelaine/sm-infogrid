...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/MandatoryStringRegex.</p>
...
public class ImplMandatoryStringRegex
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Test.MandatoryStringRegex

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMandatoryStringRegex.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMandatoryStringRegex(
            MeshObject delegate )
    {
        super( delegate );
    }
