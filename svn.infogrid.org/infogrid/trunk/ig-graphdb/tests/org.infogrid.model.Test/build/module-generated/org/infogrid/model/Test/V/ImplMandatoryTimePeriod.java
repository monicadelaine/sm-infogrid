...
/**
  * <p>Java implementation class for EntityType org.infogrid.model.Test/MandatoryTimePeriod.</p>
...
public class ImplMandatoryTimePeriod
        extends
            org.infogrid.mesh.TypedMeshObjectFacadeImpl
        implements
            org.infogrid.model.Test.MandatoryTimePeriod

{
    private static final org.infogrid.util.logging.Log log = org.infogrid.util.logging.Log.getLogInstance( ImplMandatoryTimePeriod.class ); // our own, private logger
    ...
    /**
      ...
      */
    public ImplMandatoryTimePeriod(
            MeshObject delegate )
    {
        super( delegate );
    }
