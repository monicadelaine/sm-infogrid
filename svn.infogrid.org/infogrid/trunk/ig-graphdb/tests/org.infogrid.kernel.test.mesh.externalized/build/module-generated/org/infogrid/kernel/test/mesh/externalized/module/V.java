...
package org.infogrid.kernel.test.mesh.externalized.module;
...
/**
  * Instantiates Module org.infogrid.kernel.test.mesh.externalized (no specific version given).
  */
public class V
    implements
            ...
            ModuleAdvertisementInstantiationException
    {
        try {
            ModuleAdvertisement ret = StandardModuleAdvertisement.create1(
                        "org.infogrid.kernel.test.mesh.externalized",
                        null,
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "MeshObject externalization test Module"
                                }
                        }),
                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                {
                                        null,
                                        "Tests externalization of MeshObjects"
                                }
                        }),
                        new java.util.Date( 1456080572737L ),
                        null,
                        null,
                                        ...
                                        ModuleAdvertisement.createMapFromStringArrays( new String[][] {
                                                {
                                                        ...
                                                        "org/infogrid/kernel/test/mesh/externalized/Log.properties"
                                                }
                                        }),
                                        null ),
                                ModuleRequirement.create1(
                        ...
                        new File[] {
                                new File( "dist/org.infogrid.kernel.test.mesh.externalized.jar" )
                        },
                        null,
                        null,
                        ...
                        null,
                        "configure",
                        "org.infogrid.kernel.test.mesh.externalized.AllTests",
                        "main" );
